...
//todo;    https://www.linkedin.com/in/nabil6391/
    ...
    private static final String TAG = "themettt";
    ...
    public static Spannable getTajweed(Context context, String s) {
        ...
        colors = new int[6];
            ...
            if (HbUtils.isDarkTheme(context)) {

                //currently dark theme in use

                Log.d(TAG, "getTajweed: theme is dark");

                colors[0] = ContextCompat.getColor(context, R.color.color_ghunna_dark);
                colors[1] = ContextCompat.getColor(context, R.color.color_qalqala_dark);
                colors[2] = ContextCompat.getColor(context, R.color.color_iqlab_dark);
                colors[3] = ContextCompat.getColor(context, R.color.color_idgham_dark);
                colors[4] = ContextCompat.getColor(context, R.color.color_idghamwo_dark);
                colors[5] = ContextCompat.getColor(context, R.color.color_ikhfa_dark);
            }else {

                Log.d(TAG, "getTajweed: theme is light ");
                //currently light theme in use

                colors[0] = ContextCompat.getColor(context, R.color.color_ghunna_light);
                colors[1] = ContextCompat.getColor(context, R.color.color_qalqala_light);
                colors[2] = ContextCompat.getColor(context, R.color.color_iqlab_light);
                colors[3] = ContextCompat.getColor(context, R.color.color_idgham_light);
                colors[4] = ContextCompat.getColor(context, R.color.color_idghamwo_light);
                colors[5] = ContextCompat.getColor(context, R.color.color_ikhfa_light);
            }
